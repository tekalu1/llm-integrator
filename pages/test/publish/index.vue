...
<template>
  <button @click="register" class="border border-gray-500 rounded-md px-2 py-1 mb-2" >
      登録
  </button>
  <div class="mb-8">
    <p>
  ...
  <button @click="publish" class="border border-gray-500 rounded-md px-2 py-1" >
      テスト実行
  </button>
  <div class="h-96 overflow-auto border">
